 ...
 */
class Personality_quizzes extends Public_Controller
{
	public function __construct()
	{
		...
		$this->template
			->append_css('module::personality_quizzes.css')
			->append_js('module::personality_quizzes.js');
	}
	...
	public function index($offset = 0)
	{
		...
		$items = $this->personality_quizzes_m->limit($limit)
			->offset($offset)
			->get_all();
		...
		$pagination = create_pagination('personality_quizzes', $this->personality_quizzes_m->count_all(), $limit, 2);
