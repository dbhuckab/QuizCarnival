 ...
 */
class Events_Personality_quizzes {
    ...
    public function __construct()
    {
		...
		Events::register('personality_quizzes_event', array($this, 'run'));
    }
    
    public function run()
    {
        $this->ci->load->model('personality_quizzes/personality_quizzes_m');
        
        // we're fetching this data on each front-end load. You'd probably want to do something with it IRL
        $this->ci->personality_quizzes_m->limit(5)->get_all();
    }
